...
<body id="page-top">
    ...
    <footer class=" py-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                    ...
                    <?php if(isset($_SESSION['login_id'])): ?>
                    <a class="d-block contact-support" href="javascript:void(0)">Contact Support</a>
                    <?php else: ?>
        ...
        <br>
        <div class="container">
            <div class="small text-center text-muted">Copyright © 2022 - <?php echo $_SESSION['system']['name'] ?></div>
        </div>
    </footer>
...
$('.contact-support').click(function() {
    location.href = "index.php?page=manage_messages&id=1"
